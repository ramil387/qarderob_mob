...
const ShopProductsPageHeader = () => {
    ...
    return (
        <View style={internalStyles.container}>
            ...
            <CustomText style={internalStyles.midText}>{shopStates.selectedShop?.name}</CustomText>
            <View>
                <NotificationIcon />
            </View>
        </View>
...
export default observer(ShopProductsPageHeader);
